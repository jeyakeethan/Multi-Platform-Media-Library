...
public class MPML_GUI {
    ...
    private void getVideoPanelReady(){
        ...
        videoListPanel.setLayout(new GridLayout(2,2,2,2));
        videoListPanel.setBackground(new Color(206,184,254));
        videoListPanel.setMaximumSize(new Dimension(500,500));
    ...
    public ArrayList<Song> loadSongs(String path) {
        ...
        try {
            ...
            if(!recordedLastModified.equals(realLastModified)){
                ...
                SyncSong uploadSong = new SyncSong(songs,songsLastUpdated,this.uploadToServer);
                uploadSong.start();
            }
            else{
                while(true){
                ...
                SyncSong uploadSong = new SyncSong(songs,songsLastUpdated,false);
                uploadSong.start();
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ArrayList<Video> loadVideos(String path) {
        ...
        SyncVideo uploadVideo = new SyncVideo(videos,videosLastUpdated,this.uploadToServer);
        uploadVideo.start();
        }
        else{
        while(true){
        ...
        SyncVideo uploadVideo = new SyncVideo(videos,videosLastUpdated,false);
        uploadVideo.start();
        }
        } catch (Exception e) {
        e.printStackTrace();
    ...
    public ArrayList<PDF> loadPDFs(String path) {
        ...
        try {
            ...
            if(!recordedLastModified.equals(realLastModified)||recordedLastModified.equals(0)){
                ...
                //SyncPDF uploadPDF = new SyncPDF(pdfs,pdfsLastUpdated,this.uploadToServer);
                //uploadPDF.start();
            }
            else{
                while(true){
                ...
                //SyncPDF uploadPDF = new SyncPDF(pdfs,pdfsLastUpdated,false);
                //uploadPDF.start();
            }
        } catch (Exception e) {
            e.printStackTrace();
