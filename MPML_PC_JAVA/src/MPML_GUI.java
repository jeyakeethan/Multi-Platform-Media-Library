...
public class MPML_GUI {
    ...
    private SyncPDF uploadPDF;
    private SyncVideo uploadVideo;
    private SyncSong uploadSong;
    ...
    MPML_GUI(MPML app) {
        ...
        class MouseAdapterCustom extends MouseAdapter {
            ...
            public MouseAdapterCustom(MPML_GUI mpml_gui) {
                this.mpml_gui = mpml_gui;
            }

            @Override
            public void mouseClicked(MouseEvent e) {
                mpml_gui.manuallySync();
            }
        }
        MouseAdapterCustom mouseAdapterCustom = new MouseAdapterCustom(this);
        SyncMan.addMouseListener(mouseAdapterCustom);
        try {
    ...
    public ArrayList<Song> loadSongs(String path) {
        ...
        try {
            ...
            if (!recordedLastModified.equals(realLastModified)) {
                ...
                this.uploadSong = new SyncSong(songs, songsLastUpdated, true, this.SyncToServer);
                ...
                this.uploadSong = new SyncSong(songs, songsLastUpdated, false, this.SyncToServer);
                this.uploadSong.start();
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ArrayList<Video> loadVideos(String path) {
        ...
        try {
            ...
            if (!recordedLastModified.equals(realLastModified) || recordedLastModified.equals(0)) {
                ...
                this.uploadVideo = new SyncVideo(videos, videosLastUpdated, true, this.SyncToServer);
                ...
                this.uploadVideo = new SyncVideo(videos, videosLastUpdated, false, SyncToServer);
                this.uploadVideo.start();
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ArrayList<PDF> loadPDFs(String path) {
        ...
        try {
            ...
            if (!recordedLastModified.equals(realLastModified) || recordedLastModified.equals(0)) {
                ...
                for (int i = 0; i < listOfFiles.length; i++) {
                    ...
                    try {
                        if (listOfFiles[i].isFile()) {
                            ...
                            String name = pdf.getName();//info.getTitle();
                            String author = info.getCreator();
                ...
                this.uploadPDF = new SyncPDF(pdfs, pdfsLastUpdated, true, this.SyncToServer);
                ...
                this.uploadPDF = new SyncPDF(pdfs, pdfsLastUpdated, false, this.SyncToServer);
                this.uploadPDF.start();
            }
        } catch (Exception e) {
            e.printStackTrace();
